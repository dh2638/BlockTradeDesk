...
ROOT_URLCONF = 'block_trade_desk.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'block_trade_desk.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'default': {
            'level': 'DEBUG',
            'class': 'block_trade_desk.lib.colorstreamhandler.ColorStreamHandler',
        },
        'console_dev': {
            'level': 'DEBUG',
...
CMS_TEMPLATES = (
    ('cms/single_page.html', gettext('Single page')),
)
